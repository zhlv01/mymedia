...
class VideoAdmin(admin.ModelAdmin):
    list_display = ['media_item', 'get_duration', 'media_item__user', 'media_item__is_public', 'media_item__created_at']
    search_fields = ['media_item__title', 'media_item__description']
